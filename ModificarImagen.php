...
<!--class="fa fa-area-chart"-->
                ...
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Modificar Imagen
                            ...
                            $consulta = "SELECT * FROM Publi_IMG WHERE Img_Id ='$id'";
                ...
                <div id="SubirIMGU">
                    ...
                    <form action="Proceso_Modificar.php?id=<?php echo $row['Img_Id'];?>" method="POST">
                    <h3>Modificar de Imagen</h3>

                        <label>Nombre de Imagen: *</label> <br/>
                        <input type="text" name="nombre" title="Nombre de la Imagen" placeholder="Nombre de la Imagen " value=" <?php  echo $row['Img_Nombre']; ?> " readonly="readonly"> <br/>
                        <br/>
                        <label>Imagen: *</label>
                        <img  onmouseover="this.height=300;"  onmouseout="this.height=100;" height="100" src="data:image/jpg;base64,<?php echo base64_encode($row['Img_Imagen']); ?>"><br/> <br/>

                        
                        <label>Usuario: *</label><br/>
                        <input type="text" name="usuario" title="No se puede modificar usuario" value="<?php echo($row['UserName']) ?>" readonly="readonly"><br/>


                        <label>Estado de Imagen: *</label><br/>
                        <input type="text" name="usuario" title="No se puede modificar usuario" value="<?php echo($row['Estatus']) ?>" readonly="readonly"><br/>


                        
                        <br/>
                        <label>Seleccion Estatus: *</label><br/>
                        <select name="Combo" onchange="javascript:alert('Desea Modificar el Estado de la Imagen')">
                        ...
                        <input type="button" name="Cancelar" class="btn btn-warning" value="Cancelar" onclick="location.href='IngresoImagenes.php'">
