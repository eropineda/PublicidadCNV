...
<!--class="fa fa-area-chart"-->
                ...
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Modificar Tasa de cambio
                            ...
                            $consulta = "SELECT * FROM Publi_Taza_Cambio WHERE TasaCambioId ='$id'";
                ...
                <div id="SubirIMGU">
                    ...
                    <form action="Proceso_Modificar_Tasa.php?id=<?php echo $row['TasaCambioId'];?>" method="POST">
                    <h3>Modificar Tasa de Cambio</h3>

                        <label>Precio Compra Dólar: *</label> <br/>
                        <input type="text" required="Campo Vacio" name="compra" title="Codigo del video " placeholder="Nombre de la Imagen " value=" <?php  echo $row['TasaCompraDolar']; ?> " > <br/>
                        <br/>


                        <label>Precio Venta Dólar: *</label> <br/>
                        <input type="text" required="Campo Vacio" name="venta" title="Nombre del video " placeholder="Nombre del Video " value=" <?php  echo $row['TasaVentaDolar']; ?> " > <br/>
                        <br/>
                        ...
                        <input type="text" name="estado" title="No se puede modificar usuario" value="<?php echo($row['Tasa_Estado']) ?>" readonly="readonly"><br/>
                        ...
                        <input type="button" name="Cancelar" class="btn btn-warning" value="Cancelar" onclick="location.href='Ingresartasacambio.php'">
