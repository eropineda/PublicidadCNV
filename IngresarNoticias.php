    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
                ...
                <div class="card-header">
                    <i class="fa fa-area-chart">Ingreso de Noticias</i>
                ...
                <div id="SubirVideo" >
                    ...
                    <form action="Proceso_Guardar_Noticia.php" method="POST" >
                    <h3>Registro de Noticias</h3><br/>
                    ...
                    <label>Descripcion de la Noticia: *</label> <br/>
                    <textarea rows="7" cols="70" name="Descripcion" required="Llenar Este Campo"  placeholder="Escribir la Noticia..."></textarea><br/><br/>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-table"> Vista de las Noticias </i>
                    ...
                    <table class="table table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $consulta = "SELECT `Not_Id`, `Not_Nombre`, `Not_Descripcion`, `Estatus`, `UsuarioName` FROM `Noticias`";
                            ...
                            while ($row = $resultado-> fetch_assoc()) {
                             ...
                             ?>
                                <tr >
                                    ...
                                    <td> <?php echo $row['Not_Nombre'] ?> </td>
                                    <td> <?php echo $row['Not_Descripcion'] ?> </td>
                                    <td> <?php echo $row['Estatus'] ?> </td>
                                    <td> <?php echo $row['UsuarioName'] ?> </td>
                                    <td> <a href="ModificarNoticia.php?id=<?php echo $row['Not_Id'];?> ">Modificar</a> </td>
                                    <td> <a href="Proceso_Eliminar_Noticia.php?id=<?php echo $row['Not_Id'];?>">Eliminar</a> </td>
                                </tr>
                             <?php 
                                    }
                ...
                <?php 
                    ...
                    $consulta = "SELECT UPDATE_TIME FROM information_schema.tables WHERE TABLE_SCHEMA = 'publicidad' AND TABLE_NAME = 'Noticias'";
                    $resultado= $conexion->query($consulta);
