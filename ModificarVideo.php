...
<!--class="fa fa-area-chart"-->
                ...
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Modificar Video
                            ...
                            $consulta = "SELECT * FROM Publi_Video WHERE Vid_ID ='$id'";
            ...
            <div class="card mb-3">
                <div id="SubirIMGU">
                    ...
                    <form action="Proceso_Modificar_Video.php?id=<?php echo $row['Vid_ID'];?>" method="POST">
                    <h3>Modificar Video</h3>

                        <label>Codigo de Video: *</label> <br/>
                        <input type="text" required="Campo Vacio" name="nombre" title="Codigo del video " placeholder="Nombre de la Imagen " value=" <?php  echo $row['Vid_ID']; ?> " readonly="readonly"> <br/>
                        <br/>


                        <label>Nombre de Video: *</label> <br/>
                        <input type="text" required="Campo Vacio" name="nombre" title="Nombre del video " placeholder="Nombre del Video " value=" <?php  echo $row['Vid_Nombre']; ?> " readonly="readonly"> <br/>
                        <br/>
                        ...
                        <input type="text" name="usuario" title="No se puede modificar usuario" value="<?php echo($row['Vid_Estatus']) ?>" readonly="readonly"><br/>
                        ...
                        <input type="button" name="Cancelar" class="btn btn-warning" value="Cancelar" onclick="location.href='IngresarVideo.php'">
